...
/**
 * Provides the ability to construct a byte array that is tcf compliant. The BitWriter provides
...
class BitWriter {
    ...
    /**
     * Writes an tcf encoded String of length specified by 'field'.
     */
    ...
    /**
     * Writes an tcf encoded instant value.
     */
    ...
    /**
     * Writes an tcf encoded instant value, FieldDefs.TIMESTAMP.
     */
