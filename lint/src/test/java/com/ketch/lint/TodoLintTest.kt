...
class TodoLintTest : LintDetectorTest() {
    ...
    fun testUppercaseJava() {
        ...
        val expected = """
            src/test/pkg/TestClass1.java:4: Warning: Unresolved TODO comment found [UnresolvedTodo]
              // TODO uppercase comments are detected!
              ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            0 errors, 1 warnings
        """.trimIndent()
    ...
    fun testUppercaseKotlin() {
        ...
        val expected = """
            src/test/pkg/TestClass1.kt:4: Warning: Unresolved TODO comment found [UnresolvedTodo]
              // TODO uppercase comments are detected!
              ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            0 errors, 1 warnings
        """.trimIndent()
    ...
    override fun getIssues(): List<Issue> = KetchIssueRegistry().issues
}
